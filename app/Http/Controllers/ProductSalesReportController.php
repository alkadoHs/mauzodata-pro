...
use App\Support\ProductSalesReport;
...
class ProductSalesReportController extends Controller
{
    ...
    public function __construct(
        private readonly ProductSalesReport $report,
    ...
    public function excel(Request $request): BinaryFileResponse
    {
        ...
        return Excel::download($export, $this->exportFilename('sales-by-product', $filters).'.xlsx');
    }
    ...
    public function pdf(Request $request): HttpResponse
    {
        ...
        $pdf = Pdf::loadView('reports.table', [
            ...
            'totalsRow' => ['', $totals['qty'], $totals['sales'], $totals['cost'], $totals['gp']],
        ])->setPaper('a4', 'portrait');

        return $pdf->download($this->exportFilename('sales-by-product', $filters).'.pdf');
    }
}
