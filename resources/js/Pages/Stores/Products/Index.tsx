...
import { ArrowLeft, ArrowRight, ChevronFirstIcon, ChevronLastIcon } from 'lucide-react'
...
const StoreProductIndex = ({ auth, products }: PageProps<{ products: PaginatedStoreProduct}>) => {
      ...
      <StoreLayout user={auth.user}>
          ...
          <section className="p-4">
              ...
              <div className="px-4 mx-auto py-10">
                  <DataTable columns={storeProductColumns} data={products.data} />
